...
export default function OnboardingBanner() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
      <div className="w-full max-w-sm rounded-[2rem] border border-purple-500/30 bg-[#0f0d1a] p-6">
        {/* Brand pill */}
        ...
        <div className="mt-5 space-y-2">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-white/70">Hit <span className="font-black text-white">Scan</span> — point ya camera at the barcode</p>
          </div>
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-white/70">Chuck in what the op shop's charging for it</p>
          </div>
          <div className="flex items-start gap-3">
