  ...
  if (!authenticated) {
    return (
      <main className="relative min-h-screen overflow-hidden bg-[#07070a] text-white">
        ...
        <section className="relative z-10 mx-auto flex min-h-[calc(100vh-80px)] max-w-[1400px] items-center justify-center px-4 py-10 sm:px-6 md:px-8 md:py-16">
          <div className="w-full max-w-md rounded-[2rem] border border-white/10 bg-black/72 p-8 shadow-[0_24px_80px_rgba(0,0,0,0.55)] backdrop-blur-md">
            ...
            <div className="mt-8 space-y-4">
              ...
              <button
                type="button"
                onClick={handleLogin}
                className="w-full rounded-2xl bg-purple-600 px-4 py-3 text-sm font-black uppercase tracking-[0.08em] text-white shadow-[0_0_22px_rgba(147,51,234,0.28)] transition hover:scale-[1.01] hover:bg-purple-500"
              >
                Login
              </button>
            </div>
      ...
      <section className="relative z-10 mx-auto max-w-[1400px] px-4 py-10 sm:px-6 md:px-8 md:py-16">
        <div className="max-w-4xl">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-white/72 md:text-lg">
            Add a new item to the flip journal. Track what you bought, what you
            listed it for, what it sold for, and what you learned.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] border border-white/10 bg-black/72 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.45)] backdrop-blur-md">
              ...
              <ul className="mt-5 space-y-3 text-sm leading-7 text-white/68">
                ...
                <li>• Saves the flip into your journal</li>
                <li>• Tracks status, prices, category, and dates</li>
                <li>• Feeds the Flip Log and Dashboard</li>
              </ul>
            </div>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-black/72 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.45)] backdrop-blur-md">
              ...
              <div className="mt-5 space-y-4 text-sm text-white/70">
                ...
                />
                <Summary
                  label="Listed / Sold Dates"
                  value={`${listedAt || "-"} / ${soldAt || "-"}`}
                />
