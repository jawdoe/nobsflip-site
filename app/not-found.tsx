  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#0d0b16] px-4 text-white">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-2xl font-black uppercase tracking-tight">Strewth. Don't be a galah — this page is gone.</h1>
        <p className="mt-2 text-sm text-white/40">Might've done a runner, might've never existed. She'll be right — just head back.</p>
