  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#0d0b16] px-4 text-white">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-2xl font-black uppercase tracking-tight">That page doesn't exist, mate.</h1>
        <p className="mt-2 text-sm text-white/40">Might've been moved, might've never existed. Either way, you're lost.</p>
