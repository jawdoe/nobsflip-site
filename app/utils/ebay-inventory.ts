...
export type EbayItemSpecifics = Record<string, string | string[]>;
...
function formatAspects(aspects?: EbayItemSpecifics) {
...
export async function createEbayInventoryItem(
  ...
  const formattedAspects = formatAspects(input.aspects);
